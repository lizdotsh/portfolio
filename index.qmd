...
This page is very much a WIP and not everything is on here yet.
...
This portfolio site is automatically built using quarto and deployed to Cloudflare Pages using github actions containers. Also, quarto renders all inline linked notebooks as sub pages on this site, and all static assets are hosted as well. All of these are also kept up to date, as every asset or notebook linked is downloaded at build time by build.sh and put in the assets folder directly. I also have my resume available at https://resume.lizgood.win, also hosted on cloudflare pages.

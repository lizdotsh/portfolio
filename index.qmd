...
Made an electron app that automatically processes the local sqlite databse used by Apple Photos to create an interactive visualization of various internal ML metrics used by Apple to categorize/rate your photos. Quality scores, detected age/facial expressions/race/sex/etc, etc. Made with a mix of svelte/electron/observable plot.

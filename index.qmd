...
### Apple Photos DB Examiner (WIP)
<table class="bayes">
<td> [Github](https://github.com/lizdotsh/Apple-Photos-DB-Examiner)
</tr></table>

Made an electron app that processes the local sqlite databse used by Apple Photos to create an interactive visualization of various internal ML metrics used by Apple to categorize/rate your photos. Quality scores, detected age/facial expressions/race/sex/etc, etc. Very WIP at the moment but is usable. Made with a mix of svelte/electron/observable plot.
